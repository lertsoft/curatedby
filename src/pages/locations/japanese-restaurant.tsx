...
import japanese from '@/data/JapaneseRestaurant';
  ...
  return (
    <Main
      meta={
        <Meta
          title="Curated By"
          description="This page has a list of Japanese Restaurants that I have been and that I would like to go. To Learn more check the about page 😄 😄"
        />
      }
    >
      <SubPages>
            ...
            <div className="mx-auto grid max-w-xl grid-cols-1 pt-20 ">
              ...
              {japanese.features.map((val, key) => (
                <>
                  ...
                  />
                  {key === japanese.features.length - 1 ? null : (
                    // eslint-disable-next-line tailwindcss/no-custom-classname
