  ...
  return (
    <Main
      meta={
        <Meta
          title="Curated By"
          description="This is the restaurant list of all the restaurants that I would like to go. To learn more check the about page 😄"
        />
      }
    >
      <SubPages>
        <section className="bg-white ">
          ...
          <div className="mt-4">
            <div className="mx-auto grid max-w-xl grid-cols-1 pt-20 ">
              {/* List Card */}
              {restaurants.features.map((val, key) => (
                <>
                  <LocationCard
                    key={key}
                  ...
                  />
                  {key === restaurants.features.length - 1 ? null : (
                    // eslint-disable-next-line tailwindcss/no-custom-classname
