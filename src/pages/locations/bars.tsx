  ...
  return (
    <Main
      meta={
        <Meta
          title="Curated By"
          description="This page has a list of bars that I have been to and/or that I would like to go. To Learn more check the about page 😄"
        />
      }
    >
      <SubPages>
